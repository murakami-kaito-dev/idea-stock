...
TOPICS = [
    (
        "📱 モバイルアプリ開発",
        "4日前～1日前に配信されたFlutter, iOS, App Store, インディー開発者に関するニュースやトレンドを教えてください。英語・日本語どちらの情報源でも構いませんが日本語でまとめてください。"
    ),
    (
        "🎨 UI/UX",
        "4日前～1日前に配信されたモバイル・WebアプリのUI/UXデザイン、デザインシステム、ユーザー体験に関するニュースや事例を教えてください。英語・日本語どちらの情報源でも構いませんが日本語でまとめてください。"
    ),
    (
        "📈 マーケティング",
        "4日前～1日前に配信されたアプリマーケティング、ASO、個人開発者のグロース戦略に関するニュースを教えてください。英語・日本語どちらの情報源でも構いませんが日本語でまとめてください。"
    ),
    (
        "🤖 AI",
        "4日前～1日前に配信された生成AI・LLM・個人開発者が使えるAIツールに関するニュースやリリース情報を教えてください。英語・日本語どちらの情報源でも構いませんが日本語でまとめてください。"
    ),
    (
        "💰 マネタイズ",
        "4日前～1日前に配信された個人開発アプリのマネタイズ事例、サブスク設計、フリーミアム戦略、価格設定に関するニュースを教えてください。英語・日本語どちらの情報源でも構いませんが日本語でまとめてください。"
    ),
]
